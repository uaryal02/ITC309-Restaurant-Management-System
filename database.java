...
public class database {
    ...
    protected static String dbURL = "jdbc:mysql://LAPTOP-2BCKF97F:3306/newdatabase";
    //protected static String tableName = "Employee_Table";
    protected static String tableName1 = "order_item";
    protected static String tableName2 = "OrderTable";
   ...
   Connection conn = DriverManager.getConnection(url, user, pass);
     ...
     protected static void shutdown()
    {
     ...
     //creates a new  Employee_ Table through use of a SQL statement
       ...
       //creates a new order_item through use of a SQL statement
    protected static void createTable1(){
        try{
            createConnection();
            stmt = conn.createStatement();
            stmt.execute("create table order_item (OrderID varchar(100), Starter varchar(1000), main varchar(1000), Dessert varchar(1000), Drink varchar(1000), Price varchar(100))");
            stmt.close();
     ...
     //creates a new OrderTable through use of a SQL statement
    protected static void createTable2(){
        try{
            createConnection();
            stmt = conn.createStatement();
            stmt.execute("create table OrderTable (OrderID varchar(100), TableNum varchar(1000),  TotalPrice varchar(100))");
            stmt.close();
    ...
    protected static void createMainTable(){
        try{
            createConnection();
            stmt = conn.createStatement();
            stmt.execute("create table Main_TABLE (Main varchar(100), MainPrice varchar(100))");
            stmt.close();
    ...
    protected static void createDrinkTable(){
     ...
     protected static void dropTable1(){
        try{
            createConnection();
            stmt = conn.createStatement();
            stmt.execute("drop table order_item");
            stmt.close();
