 ...
 this.id = id;
    ...
    button.setOnAction(evt -> {
        try {
            ...
            stmt.execute("CREATE TABLE IF NOT EXISTS cart ( ID INT NOT NULL AUTO_INCREMENT,ITEM VARCHAR(45),PRICE VARCHAR(45),TIME VARCHAR(45),Table_Num int, PRIMARY KEY (ID));");
            stmt.close();
            stmt=connection.createStatement();
